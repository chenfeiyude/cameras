package com.feiyu4fun.cameras.configurations.datasource;
...
@EnableJpaRepositories(
		basePackages = {"com.feiyu4fun.cameras.interfaces.daos.management"},
...
public class ManagementDataSourceConfig extends CommonDataSourceConfig {
    ...
    public LocalSessionFactoryBean managementSessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.feiyu4fun.cameras.dtos.management" });
    ...
    public LocalContainerEntityManagerFactoryBean managementEntityManagerFactory() {
         ...
         em.setPackagesToScan(new String[] { "com.feiyu4fun.cameras.dtos.management" });
